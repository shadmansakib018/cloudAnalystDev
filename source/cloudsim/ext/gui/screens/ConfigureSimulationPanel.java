...
public class ConfigureSimulationPanel extends JPanel 
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals(CMD_ADD_NEW_USERBASE)){
			...
			System.out.println("configsimulation file line 712: UserBase created " + userBases);
			String ubName;
			do {
				ubName = "UB" + userBases++;
			...
			System.out.println("configsim file line 745: add new Data center");
			addNewDC();
			...
			System.out.println("configsim file line 753: add new machine");
			...
			System.out.println("configsim file line 798: add new VM");
			addVmAllocation();																	 
...
//		}
	...
	private class DataCenterTableModel extends AbstractListTableModel<DataCenterUIElement> {
		...
		protected void setValueAtInternal(Object value, int row, int col) {
			...
			System.out.println("updating value of DC table at row col" + row + " " + col);
	...
	private class MachineTableModel extends AbstractListTableModel<MachineUIElement> {
		...
		protected void setValueAtInternal(Object value, int row, int col) {
			...
			System.out.println("updating value of machine table at row col" + row + " " + col);
